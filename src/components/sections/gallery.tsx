...
export default function Gallery() {
    ...
    return (
      ...
      <div className="flex max-w-full flex-wrap items-center justify-center gap-4">
        ...
        {images.map((image) => (
          ...
          >
            <img
              className="peer min-h-full w-full object-cover transition-all duration-500 hover:scale-105 hover:brightness-75"
              src={image.path}
              width={1000}
              height={1000}
              alt={image.title}
  ...
  return (
    <section className="relative flex h-full w-full flex-col justify-center gap-5 overflow-hidden p-4 dark:bg-zinc-950">
      <head>
        <title>ASTROV gallery</title>
      </head>
      {/* Title */}
      <Container className="flex items-center justify-start">
        <h1 className="dark:text-astrov-50 font-alt text-6xl font-bold uppercase tracking-widest text-astrov-400 sm:text-7xl md:text-9xl">
          Gallery
        </h1>
      </Container>
      {/* Image List */}
          ...
          >
            ...
            >
              ...
              <img
                ...
                height={1000}
                className={cn(
                  'min-h-full w-full rounded-lg object-cover',
